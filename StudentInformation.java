...
PreparedStatement pst=null;
 ...
 private void Update_table() {
    ...
    private void initComponents() {
        ...
        txt_enrolldate = new javax.swing.JLabel();
        txt_gpa = new javax.swing.JLabel();
        ...
        txt_enrolldate.setText("Enrollment date");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(date_dob, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_enrolldate)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(1, 1, 1)
                                .addComponent(date_enroll, javax.swing.GroupLayout.DEFAULT_SIZE, 169, Short.MAX_VALUE))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txt_enrolldate)
                    .addComponent(date_enroll, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txt_gpa)
    ...
    private void cmd_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_saveActionPerformed
        // TODO add your handling code here:
        int confirm = JOptionPane.showConfirmDialog(null, "Are you sure you want to add this record?", "Add Record", JOptionPane.YES_NO_OPTION);
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        try {
           ...
           + "(student_id, first_name, surname, date_of_birth, gender, email, "
           + "contact_number, address_line1, enrollment_date, gpa, course_code, image) "
           + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd"); 

        Date dobDate = date_dob.getDate();      // 
        Date enrollDate = date_enroll.getDate(); // 

            String dobFormatted = "";
            String enrollFormatted = "";

        if (dobDate != null) {
             dobFormatted = sdf.format(dobDate);   
        }

        if (enrollDate != null) {
             enrollFormatted = sdf.format(enrollDate);
        }
            pst = conn.prepareStatement(sql);
            pst.setString(1, txt_studentid.getText());
            pst.setString(2, txt_firstname.getText());
            pst.setString(3, txt_surname.getText());
            pst.setString(4, dobFormatted);
            pst.setString(5, gender != null ? gender : "");
            pst.setString(6, txt_email.getText());
            pst.setString(7, txt_tel.getText());
            pst.setString(8, txt_address.getText());
            pst.setString(9, enrollFormatted);
            String gpaText = txt_pc.getText();

            if (gpaText != null && !gpaText.trim().isEmpty()) {
              gpaText = gpaText.trim();

          // Check format only digits and optional dot decimal
          try {
             double gpaValue = Double.parseDouble(gpaText);
             if (gpaValue < 0.0 || gpaValue > 4.0) {
               JOptionPane.showMessageDialog(null, "GPA must be between 0.0 and 4.0");
               return;
         }
             pst.setDouble(10, gpaValue);
                } catch (NumberFormatException e) {
             JOptionPane.showMessageDialog(null, "GPA must be a valid decimal number!");
              return;
                }
            ...
            pst.executeUpdate();
        JOptionPane.showMessageDialog(null, "Data saved with image successfully.");
        ...
        try {
            ...
            pst.setString(3, "Added Record");

            pst.executeUpdate();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Audit Log Error: " + e.getMessage());
        } finally {
            // Close resources
            try {
                if (rs != null) rs.close();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(p==0){
           SimpleDateFormat sdfdate = new SimpleDateFormat ("yyyy-MM-dd");
            ...
            if (dobDate != null) {
                 value3 = sdfdate.format(dobDate);
            }

            if (enrollDate != null) {
                value10 = sdfdate.format(enrollDate);
}
            try{
                ...
                String sql = "UPDATE Student_Information SET first_name=?, surname=?, Dob=?, Email=?, Telephone=?, Address=?, Address2=?, Apartment=?, Post_code=? WHERE id=?";
                pst = conn.prepareStatement(sql);
                ...
                pst.setString(7, value9);
                pst.setString(8, value10);
                pst.setString(9, value11);
...
Update_table();
    ...
    private void txt_search1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_search1ActionPerformed
        // TODO add your handling code here:String studentID = txt_search1.getText().trim();
    ...
    private void txt_search1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_search1KeyReleased
        ...
        try{
            ...
            if (dobStr != null && !dobStr.isEmpty()) {
                try {
                    Date dobDate = new SimpleDateFormat("yyyy-MM-dd").parse(dobStr);
                    date_dob.setDate(dobDate);
                } catch (Exception e) {
                    e.printStackTrace();
                    date_dob.setDate(null);
                }
            ...
            String enrollStr = rs.getString("Enrollment");
            if (enrollStr != null && !enrollStr.isEmpty()) {
                try {
                    Date enrollDate = new SimpleDateFormat("yyyy-MM-dd").parse(enrollStr);
                    date_enroll.setDate(enrollDate);
                } catch (Exception e) {
                    e.printStackTrace();
                    date_enroll.setDate(null);
                }
            } else {
                date_enroll.setDate(null);
            }
    ...
    private javax.swing.JLabel txt_enrolldate;
    private javax.swing.JTextField txt_firstname;
    private javax.swing.JLabel txt_gpa;
